...
model_path = our_path + '/code/ETC_model.pkl'
preexercise_path = our_path + '/datasets/resting_ECG_3.txt'
postexercise_path = our_path + '/datasets/exercise_ECG_3.txt'
print("Reading data from: ",preexercise_path)
